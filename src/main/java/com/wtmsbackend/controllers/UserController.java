...
public class UserController {
    ...
    @Operation(
            ...
            description = "Registers a new user in the system with image upload to Cloudinary. Send as multipart/form-data with 'request' (JSON string) and optional 'image' (file)."
    )
    @PostMapping(value = "/upload", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public ResponseEntity<?> createUserWithImage(@RequestPart("request") String requestJson, @RequestPart(value = "image", required = false) MultipartFile image) {
        try {
    ...
    @Operation(
            ...
            description = "Registers a new user in the system with JSON payload. No image upload support. Send as application/json."
    )

...
//
//        ApiResponse<PagedResponse<NotificationResponse>> response = ApiResponse.<PagedResponse<NotificationResponse>>builder()
//                .message("Notifications fetched successfully!")
//                .success(true)
//                .payload(buildPagedResponse(notificationPage))
...
//    public ResponseEntity<ApiResponse<PagedResponse<NotificationResponse>>> getUnreadUserNotifications(
//            @PathVariable Integer userId,
//            @RequestParam(defaultValue = "0") int page,
//            @RequestParam(defaultValue = "10") int size
//    ) {
...
public class NotificationController {
    ...
    public ResponseEntity<ApiResponse<List<NotificationResponse>>> getAllNotifications(
        ...
        List<NotificationResponse> notificationPage = notificationService.getAllNotifications(page, size);
    ...
    public ResponseEntity<ApiResponse<List<NotificationResponse>>> getUserNotifications(
        ...
        List<NotificationResponse> notificationPage = notificationService.getUserNotifications(userId, page, size);
    ...
    public ResponseEntity<ApiResponse<List<NotificationResponse>>> getUnreadUserNotifications(
        ...
        List<NotificationResponse> notificationPage = notificationService.getUnreadUserNotifications(userId, page, size);

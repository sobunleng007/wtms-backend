...
public class MaterialController {
  ...
  @Operation(
      ...
      description = "Retrieves a list of all training materials in the system.")
  @GetMapping
  public ResponseEntity<ApiResponse<List<MaterialResponse>>> getAllMaterials() {
    ...
    ApiResponse<List<MaterialResponse>> response =
        ApiResponse.<List<MaterialResponse>>builder()
  ...
  @Operation(
      summary = "Get materials by Session ID",
      description = "Retrieves a list of materials assigned to a specific training session.")
  ...
  @Operation(
      ...
      description = "Retrieves specific material details using its unique ID.")
  @GetMapping("/{id}")
  public ResponseEntity<ApiResponse<MaterialResponse>> getMaterialById(@PathVariable Integer id) {
    ...
    ApiResponse<MaterialResponse> response =
        ApiResponse.<MaterialResponse>builder()
  ...
  @Operation(
      ...
      description = "Uploads/Creates a new training material. Requires ADMIN or TRAINER role.")
  @PostMapping
  ...
  @Operation(
      ...
      description = "Updates details of an existing material. Requires ADMIN or TRAINER role.")
  @PutMapping("/{id}")
  @PreAuthorize("hasAnyAuthority('ADMIN', 'TRAINER')")
  public ResponseEntity<ApiResponse<MaterialResponse>> updateMaterial(
      @PathVariable Integer id, @Valid @RequestBody MaterialRequest request) {
  ...
  @Operation(
      ...
      description =
          "Permanently deletes a material from the database. Requires ADMIN or TRAINER role.")
  @DeleteMapping("/{id}")
  @PreAuthorize("hasAnyAuthority('ADMIN', 'TRAINER')")
